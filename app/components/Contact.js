    ...
    <section id="contact" className="py-20" ref={sectionRef}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <a
            href="mailto:nnaemeka.obiefuna@gmail.com"
            className={`inline-block px-8 py-4 bg-accent hover:bg-accent-hover text-white font-medium rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-accent/30 ${
